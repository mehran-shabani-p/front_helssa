...
- Add test for service by baseurl='https://api.medogram.ir/'
- Configure Flutter SDK in CI to run analyzer and tests.
- Expand coverage for subscription and certificate API services.
- Optimize MLKit text recognition dependencies and add ProGuard rules if release size grows.
